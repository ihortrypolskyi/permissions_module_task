...
ActiveRecord::Schema.define(version: 2019_10_14_193700) do
  ...
  create_table "callers", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["token"], name: "index_callers_on_token", unique: true
  end

  create_table "resource_permissions", force: :cascade do |t|
    t.text "permission_status", default: [], array: true
    t.integer "user_id"
    t.integer "role_id"
    t.integer "resource_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id", "role_id", "resource_id"], name: "resource_permissions_index"
  end
